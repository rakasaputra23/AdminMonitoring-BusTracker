...
export default function Armada({ auth, armada, filters }) {
  ...
  const resetFilters = () => {
    ...
    setKelasFilter('');
    setStatusFilter('');
    router.get('/data-master/armada', {}, { preserveState: true, preserveScroll: true });
  };
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Nama Bus <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Kelas Bus <span className="text-red-500">*</span>
                  </label>
                  <select
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="40"
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                      errors.kapasitas ? 'border-red-400 bg-red-50' : 'border-gray-300'
                    }`}
                  />
                  {errors.kapasitas && <p className="text-red-600 text-xs mt-1">{errors.kapasitas}</p>}
                </div>
              </div>
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  <span className="font-semibold">{armadaToDelete?.nama_bus}</span>?
                </p>
              </div>
            </div>
